	...
	<div class="panel-body">
	  	<form method="post" id="frm_laporan" name="frm_laporan" autocomplete="off">
		  	<div class="row row-pad-5">
				...
				<div class="col-lg-2">
					<input type="text" class="form-control" id="nomor_aju" name="nomor_aju" placeholder="No. Aju">
				</div>
				<div class="col-lg-2">
		    ...
		    <div class="btn-group">
			    <a href="javascript:void(0);" class="btn btn-primary" onclick="Laporan('frm_laporan', 'table-laporan','<?php echo site_url('report/proses/pemasukan');?>','laporan');"><i class="fa fa-search"></i>&nbsp;Search</a>
